...
<tr>
	<td valign='top'><textarea name='mess' id='mess' class='txt' rows="2" cols="70" maxlength='1000' onKeyDown="return add_js(event)" onclick="return update(event);" onKeyUp="return update(event);"></textarea></td>
	<td valign='top'>
		<select name='to'><option value='0'>Všem (<?php echo $counter;?>)</option>
		<?php echo $uSel."\n"; ?>
		</select><input type='checkbox' name='chb' value='save' style='margin:0 2px 1px 5px'<?php echo $checkedBox; ?> /><input type='submit' value='Odeslat' />&nbsp; | &nbsp;<input type='button' onClick="window.parent.location.href='/room/<?php echo $_GET['id']; ?>/'" value='Refresh' /><input type='button' onClick="window.parent.game.location.href='game.php?id=<?php echo $_GET['id']; ?>&amp;set=1'" value='Nastavení' /><?php echo $allowDel;?><input type='button' onClick="location.href='play.php?id=<?php echo $_GET['id']; ?>&amp;l=1'" value='Odejít' />
...
<script type="text/javascript">/* <![CDATA[ */document.forms['chat']['mess'].focus();/* ]]> */</script>
</body></html>